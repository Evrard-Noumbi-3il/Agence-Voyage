...
echo "   -> Username : gev-api-service" 
echo "   -> Attach policy : readwrite" 
echo "   -> Copier Access Key et Secret Key generees" 
echo "   -> Charger dans Vault :" 
echo "      docker exec adv-vault vault kv put secret/gev/minio " 
echo "        access_key=GEV_ACCESS_KEY_ICI " 
echo "        secret_key=GEV_SECRET_KEY_ICI " 
